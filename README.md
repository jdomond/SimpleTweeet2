# Project 2 - *twitterClient part 2*

**twitterClient part 2** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/jdomond/SimpleTweeet2/blob/master/walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
